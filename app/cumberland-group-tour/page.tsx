...
const CUMBERLAND_FORMSPREE_ENDPOINT = getGroupTourFormspreeEndpoint("cumberland");

export default function CumberlandGroupTourForm() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await fetch(CUMBERLAND_FORMSPREE_ENDPOINT, {
        method: "POST",
        headers: {
        ...
        body: JSON.stringify({
          ...form,
          tourName: "Cumberland Group Tour",
          tourDates: "September 24-27, 2026",
        }),
      });
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-black text-white flex items-center justify-center p-6">
      <div className="max-w-5xl w-full bg-white/10 backdrop-blur-xl rounded-3xl shadow-2xl grid md:grid-cols-2 overflow-hidden">
        <div className="p-8 bg-gradient-to-br from-green-700 to-amber-600">
          <h1 className="text-3xl font-bold mb-4">🍂 Cumberland Group Tour</h1>
          <p className="text-sm opacity-90 mb-6">September 24-27, 2026</p>

          <ul className="space-y-3 text-sm">
            <li>✔ Canal Place Heritage Area</li>
            <li>✔ Scenic Railroad ride</li>
            <li>✔ Rocky Gap State Park</li>
            <li>✔ Great Allegheny Passage</li>
            <li>✔ Downtown shops & cafés</li>
            <li>✔ C&O Canal walk</li>
          </ul>

          <div className="mt-8 text-sm">
            <p><strong>👥 Spots Left:</strong> 20 / 24</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-4">
          ...
          <button
            ...
            className="w-full bg-gradient-to-r from-green-700 to-amber-600 hover:scale-105 transition-transform p-3 rounded-xl font-semibold"
          >
