...
const LOS_ANGELES_FORMSPREE_ENDPOINT = getGroupTourFormspreeEndpoint("losAngeles");

export default function LosAngelesGroupTourForm() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await fetch(LOS_ANGELES_FORMSPREE_ENDPOINT, {
        method: "POST",
        headers: {
        ...
        body: JSON.stringify({
          ...form,
          tourName: "Los Angeles Group Tour",
          tourDates: "October 15-18, 2026",
        }),
      });
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-black text-white flex items-center justify-center p-6">
      <div className="max-w-5xl w-full bg-white/10 backdrop-blur-xl rounded-3xl shadow-2xl grid md:grid-cols-2 overflow-hidden">
        <div className="p-8 bg-gradient-to-br from-yellow-500 to-pink-600">
          <h1 className="text-3xl font-bold mb-4">🌴 Los Angeles Group Tour</h1>
          <p className="text-sm opacity-90 mb-6">October 15-18, 2026</p>

          <ul className="space-y-3 text-sm">
            <li>✔ Santa Monica Pier & beach</li>
            <li>✔ Venice Beach boardwalk</li>
            <li>✔ Hollywood Walk of Fame</li>
            <li>✔ Griffith Observatory sunset</li>
            <li>✔ Beverly Hills & Rodeo Drive</li>
            <li>✔ Malibu coastal drive</li>
          </ul>

          <div className="mt-8 text-sm">
            <p><strong>👥 Spots Left:</strong> 21 / 28</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-4">
          ...
          <button
            ...
            className="w-full bg-gradient-to-r from-yellow-500 to-pink-600 hover:scale-105 transition-transform p-3 rounded-xl font-semibold"
          >
