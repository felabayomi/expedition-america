...
const SEATTLE_FORMSPREE_ENDPOINT = getGroupTourFormspreeEndpoint("seattle");

export default function SeattleGroupTourForm() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await fetch(SEATTLE_FORMSPREE_ENDPOINT, {
        method: "POST",
        headers: {
        ...
        body: JSON.stringify({
          ...form,
          tourName: "Seattle Group Tour",
          tourDates: "July 16-19, 2026",
        }),
      });
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-black text-white flex items-center justify-center p-6">
      <div className="max-w-5xl w-full bg-white/10 backdrop-blur-xl rounded-3xl shadow-2xl grid md:grid-cols-2 overflow-hidden">
        <div className="p-8 bg-gradient-to-br from-emerald-700 to-slate-600">
          <h1 className="text-3xl font-bold mb-4">🌲 Seattle Group Tour</h1>
          <p className="text-sm opacity-90 mb-6">July 16-19, 2026</p>

          <ul className="space-y-3 text-sm">
            <li>✔ Pike Place Market</li>
            <li>✔ Space Needle views</li>
            <li>✔ Chihuly Garden & Glass</li>
            <li>✔ Bainbridge Island ferry</li>
            <li>✔ Optional Mount Rainier</li>
            <li>✔ Coffee & waterfront dining</li>
          </ul>

          <div className="mt-8 text-sm">
            <p><strong>👥 Spots Left:</strong> 19 / 26</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-4">
          ...
          <button
            ...
            className="w-full bg-gradient-to-r from-emerald-700 to-slate-600 hover:scale-105 transition-transform p-3 rounded-xl font-semibold"
          >
