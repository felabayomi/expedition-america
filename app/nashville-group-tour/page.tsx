...
const NASHVILLE_FORMSPREE_ENDPOINT = getGroupTourFormspreeEndpoint("nashville");

export default function NashvilleGroupTourForm() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await fetch(NASHVILLE_FORMSPREE_ENDPOINT, {
        method: "POST",
        headers: {
        ...
        body: JSON.stringify({
          ...form,
          tourName: "Nashville Group Tour",
          tourDates: "October 22-25, 2026",
        }),
      });
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-black text-white flex items-center justify-center p-6">
      <div className="max-w-5xl w-full bg-white/10 backdrop-blur-xl rounded-3xl shadow-2xl grid md:grid-cols-2 overflow-hidden">
        <div className="p-8 bg-gradient-to-br from-purple-700 to-yellow-500">
          <h1 className="text-3xl font-bold mb-4">🎸 Nashville Group Tour</h1>
          <p className="text-sm opacity-90 mb-6">October 22-25, 2026</p>

          <ul className="space-y-3 text-sm">
            <li>✔ Broadway live music</li>
            <li>✔ Country Music Hall of Fame</li>
            <li>✔ Ryman Auditorium tour</li>
            <li>✔ Johnny Cash Museum</li>
            <li>✔ 12 South murals</li>
            <li>✔ Hot chicken tasting</li>
          </ul>

          <div className="mt-8 text-sm">
            <p><strong>👥 Spots Left:</strong> 18 / 28</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-4">
          ...
          <button
            ...
            className="w-full bg-gradient-to-r from-purple-700 to-yellow-500 hover:scale-105 transition-transform p-3 rounded-xl font-semibold"
          >
