...
const MIAMI_FORMSPREE_ENDPOINT = getGroupTourFormspreeEndpoint("miami");

export default function MiamiGroupTourForm() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await fetch(MIAMI_FORMSPREE_ENDPOINT, {
        method: "POST",
        headers: {
        ...
        body: JSON.stringify({
          ...form,
          tourName: "Miami Group Tour",
          tourDates: "December 10-13, 2026",
        }),
      });
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-black text-white flex items-center justify-center p-6">
      <div className="max-w-5xl w-full bg-white/10 backdrop-blur-xl rounded-3xl shadow-2xl grid md:grid-cols-2 overflow-hidden">
        <div className="p-8 bg-gradient-to-br from-pink-500 to-orange-500">
          <h1 className="text-3xl font-bold mb-4">🌴 Miami Group Tour</h1>
          <p className="text-sm opacity-90 mb-6">December 10-13, 2026</p>

          <ul className="space-y-3 text-sm">
            <li>✔ South Beach relaxation</li>
            <li>✔ Ocean Drive nightlife</li>
            <li>✔ Wynwood Walls tour</li>
            <li>✔ Little Havana experience</li>
            <li>✔ Bayside Marketplace</li>
            <li>✔ Optional Everglades trip</li>
          </ul>

          <div className="mt-8 text-sm">
            <p><strong>👥 Spots Left:</strong> 22 / 30</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-4">
          ...
          <button
            ...
            className="w-full bg-gradient-to-r from-pink-500 to-orange-500 hover:scale-105 transition-transform p-3 rounded-xl font-semibold"
          >
