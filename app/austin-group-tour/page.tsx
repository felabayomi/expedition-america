...
const AUSTIN_FORMSPREE_ENDPOINT = getGroupTourFormspreeEndpoint("austin");

export default function AustinGroupTourForm() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await fetch(AUSTIN_FORMSPREE_ENDPOINT, {
        method: "POST",
        headers: {
        ...
        body: JSON.stringify({
          ...form,
          tourName: "Austin Group Tour",
          tourDates: "November 5-8, 2026",
        }),
      });
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-black text-white flex items-center justify-center p-6">
      <div className="max-w-5xl w-full bg-white/10 backdrop-blur-xl rounded-3xl shadow-2xl grid md:grid-cols-2 overflow-hidden">
        <div className="p-8 bg-gradient-to-br from-amber-500 to-green-600">
          <h1 className="text-3xl font-bold mb-4">🤠 Austin Group Tour</h1>
          <p className="text-sm opacity-90 mb-6">November 5-8, 2026</p>

          <ul className="space-y-3 text-sm">
            <li>✔ South Congress shopping & murals</li>
            <li>✔ Congress Bridge bat viewing</li>
            <li>✔ Texas State Capitol tour</li>
            <li>✔ Barton Springs & Zilker Park</li>
            <li>✔ Hill Country wineries</li>
            <li>✔ Live music on Rainey Street</li>
          </ul>

          <div className="mt-8 text-sm">
            <p><strong>👥 Spots Left:</strong> 19 / 28</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-4">
          ...
          <button
            ...
            className="w-full bg-gradient-to-r from-amber-500 to-green-600 hover:scale-105 transition-transform p-3 rounded-xl font-semibold"
          >
