...
const LAS_VEGAS_FORMSPREE_ENDPOINT = getGroupTourFormspreeEndpoint("lasVegas");

export default function LasVegasGroupTourForm() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await fetch(LAS_VEGAS_FORMSPREE_ENDPOINT, {
        method: "POST",
        headers: {
        ...
        body: JSON.stringify({
          ...form,
          tourName: "Las Vegas Group Tour",
          tourDates: "Nov 12–15, 2026",
        }),
      });
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-black text-white flex items-center justify-center p-6">
      <div className="max-w-5xl w-full bg-white/10 backdrop-blur-xl rounded-3xl shadow-2xl grid md:grid-cols-2 overflow-hidden">
        ...
        <div className="p-8 bg-gradient-to-br from-fuchsia-600 to-purple-800">
          <h1 className="text-3xl font-bold mb-4">🎰 Las Vegas Group Tour</h1>
          <p className="text-sm opacity-90 mb-6">November 12–15, 2026</p>

          <ul className="space-y-3 text-sm">
            <li>✔ Las Vegas Strip experience</li>
            <li>✔ Bellagio fountains</li>
            <li>✔ High Roller observation wheel</li>
            <li>✔ Fremont Street light show</li>
            <li>✔ Optional Red Rock Canyon</li>
            <li>✔ Live entertainment night</li>
          </ul>

          <div className="mt-8 text-sm">
            <p><strong>👥 Spots Left:</strong> 19 / 30</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-4">
          ...
          <button
            ...
            className="w-full bg-gradient-to-r from-fuchsia-600 to-purple-800 hover:scale-105 transition-transform p-3 rounded-xl font-semibold"
          >
