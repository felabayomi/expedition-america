...
const MORGANTOWN_FORMSPREE_ENDPOINT = getGroupTourFormspreeEndpoint("morgantown");

export default function MorgantownGroupTourForm() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await fetch(MORGANTOWN_FORMSPREE_ENDPOINT, {
        method: "POST",
        headers: {
        ...
        body: JSON.stringify({
          ...form,
          tourName: "Morgantown Group Tour",
          tourDates: "September 17-20, 2026",
        }),
      });
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-black text-white flex items-center justify-center p-6">
      <div className="max-w-5xl w-full bg-white/10 backdrop-blur-xl rounded-3xl shadow-2xl grid md:grid-cols-2 overflow-hidden">
        <div className="p-8 bg-gradient-to-br from-blue-900 to-yellow-500">
          <h1 className="text-3xl font-bold mb-4">🏈 Morgantown Group Tour</h1>
          <p className="text-sm opacity-90 mb-6">September 17-20, 2026</p>

          <ul className="space-y-3 text-sm">
            <li>✔ WVU campus tour</li>
            <li>✔ Coopers Rock overlook</li>
            <li>✔ Mon River Rail Trail</li>
            <li>✔ Downtown High Street</li>
            <li>✔ Optional football game</li>
            <li>✔ Brewery & live music</li>
          </ul>

          <div className="mt-8 text-sm">
            <p><strong>👥 Spots Left:</strong> 19 / 24</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-4">
          ...
          <button
            ...
            className="w-full bg-gradient-to-r from-blue-900 to-yellow-500 hover:scale-105 transition-transform p-3 rounded-xl font-semibold"
          >
