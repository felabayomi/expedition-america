...
const BOSTON_FORMSPREE_ENDPOINT = getGroupTourFormspreeEndpoint("boston");

export default function BostonGroupTourForm() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await fetch(BOSTON_FORMSPREE_ENDPOINT, {
        method: "POST",
        headers: {
        ...
        body: JSON.stringify({
          ...form,
          tourName: "Boston Group Tour",
          tourDates: "Oct 8–11, 2026",
        }),
      });
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-black text-white flex items-center justify-center p-6">
      <div className="max-w-5xl w-full bg-white/10 backdrop-blur-xl rounded-3xl shadow-2xl grid md:grid-cols-2 overflow-hidden">
        ...
        <div className="p-8 bg-gradient-to-br from-red-700 to-amber-500">
          <h1 className="text-3xl font-bold mb-4">🍁 Boston Group Tour</h1>
          <p className="text-sm opacity-90 mb-6">October 8–11, 2026</p>

          <ul className="space-y-3 text-sm">
            <li>✔ Freedom Trail tour</li>
            <li>✔ Boston Common &amp; Garden</li>
            <li>✔ North End dining</li>
            <li>✔ Harvard campus visit</li>
            <li>✔ Charles River walk</li>
            <li>✔ Beacon Hill photos</li>
          </ul>

          <div className="mt-8 text-sm">
            <p><strong>👥 Spots Left:</strong> 20 / 28</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-4">
          ...
          <button
            ...
            className="w-full bg-gradient-to-r from-red-700 to-amber-500 hover:scale-105 transition-transform p-3 rounded-xl font-semibold"
          >
